...
class S {
  ...
  String get outletsBlockSubtitle => _t('outletsBlockSubtitle');
  String get outletsEmptyTitle => _t('outletsEmptyTitle');
  String get outletsEmptySubtitle => _t('outletsEmptySubtitle');
  String get outletAdd => _t('outletAdd');
  String get outletNew => _t('outletNew');
  String get outletEdit => _t('outletEdit');
  String get outletNameLabel => _t('outletNameLabel');
  String get outletNameHint => _t('outletNameHint');
  String get outletAddressHint => _t('outletAddressHint');
  String get outletUseLocation => _t('outletUseLocation');
  String get outletLocationSaved => _t('outletLocationSaved');
  String get outletPhones => _t('outletPhones');
  String get outletPhoneAdd => _t('outletPhoneAdd');
  String get outletNoteLabel => _t('outletNoteLabel');
  String get outletPhotoPick => _t('outletPhotoPick');
  String get outletPhotoRemove => _t('outletPhotoRemove');
  String get outletSaved => _t('outletSaved');
  String get outletDeleteTitle => _t('outletDeleteTitle');
  String outletDeleteBody(String name) => _t('outletDeleteBody').replaceAll('{name}', name);
  String get outletDelivered => _t('outletDelivered');
  String get outletPaid => _t('outletPaid');
  String get outletReturned => _t('outletReturned');
  String get outletBalance => _t('outletBalance');
  String get outletBalanceOwes => _t('outletBalanceOwes');
  String get outletBalancePrepaid => _t('outletBalancePrepaid');
  String get outletBalanceSettled => _t('outletBalanceSettled');
  String get outletActionDeliver => _t('outletActionDeliver');
  String get outletActionReturn => _t('outletActionReturn');
  String get outletActionPay => _t('outletActionPay');
  String get outletEntryDelivery => _t('outletEntryDelivery');
  String get outletEntryReturn => _t('outletEntryReturn');
  String get outletEntryPayment => _t('outletEntryPayment');
  String get outletEntryCashOnDelivery => _t('outletEntryCashOnDelivery');
  String get outletLedgerEmpty => _t('outletLedgerEmpty');
  String get outletFilterAll => _t('outletFilterAll');
  String get outletDeliverTitle => _t('outletDeliverTitle');
  String get outletReturnTitle => _t('outletReturnTitle');
  String get outletPayTitle => _t('outletPayTitle');
  String get outletItemsHint => _t('outletItemsHint');
  String get outletPaidNowLabel => _t('outletPaidNowLabel');
  String get outletPaidNowHint => _t('outletPaidNowHint');
  String get outletTotalLabel => _t('outletTotalLabel');
  String get outletAmountLabel => _t('outletAmountLabel');
  String get outletEntrySaved => _t('outletEntrySaved');
  String get outletEntryDeleteBody => _t('outletEntryDeleteBody');
  String get outletValidationItems => _t('outletValidationItems');
  String get outletValidationAmount => _t('outletValidationAmount');
  String get outletPaidExceeds => _t('outletPaidExceeds');
  String get cashSettingTrackOutlets => _t('cashSettingTrackOutlets');
  String get cashSettingTrackOutletsDesc => _t('cashSettingTrackOutletsDesc');
  String get dashboardOutletCredit => _t('dashboardOutletCredit');
  String get outletEdgeHint => _t('outletEdgeHint');
  ...
  static const _uz = {
    ...
    'outletsEmptyTitle': 'Do‘konlar hali yo‘q',
    'outletsEmptySubtitle': 'Mahsulot tarqatadigan do‘konlaringizni qo‘shing — berilgan mahsulot, to‘lov va qoldiq shu yerda yuritiladi.',
    'outletAdd': 'Do‘kon qo‘shish',
    'outletNew': 'Yangi do‘kon',
    'outletEdit': 'Do‘konni tahrirlash',
    'outletNameLabel': 'Do‘kon nomi',
    'outletNameHint': 'Masalan: Chorsu do‘koni',
    'outletAddressHint': 'Ko‘cha, mo‘ljal',
    'outletUseLocation': 'Joylashuvni olish',
    'outletLocationSaved': 'Joylashuv olindi',
    'outletPhones': 'Telefon raqamlar',
    'outletPhoneAdd': 'Raqam qo‘shish',
    'outletNoteLabel': 'Izoh',
    'outletPhotoPick': 'Rasm tanlash',
    'outletPhotoRemove': 'Rasmni olib tashlash',
    'outletSaved': 'Do‘kon saqlandi',
    'outletDeleteTitle': 'Do‘konni o‘chirish',
    'outletDeleteBody': '«{name}» o‘chirilsinmi? Hisob-kitob tarixi saqlanib qoladi.',
    'outletDelivered': 'Berildi',
    'outletPaid': 'To‘landi',
    'outletReturned': 'Qaytdi',
    'outletBalance': 'Qoldiq',
    'outletBalanceOwes': 'Do‘kon qarzi',
    'outletBalancePrepaid': 'Oldindan to‘langan',
    'outletBalanceSettled': 'Hisob teng',
    'outletActionDeliver': 'Berish',
    'outletActionReturn': 'Qaytarish',
    'outletActionPay': 'To‘lov',
    'outletEntryDelivery': 'Mahsulot berildi',
    'outletEntryReturn': 'Mahsulot qaytdi',
    'outletEntryPayment': 'To‘lov qabul qilindi',
    'outletEntryCashOnDelivery': 'Berishda naqd',
    'outletLedgerEmpty': 'Bu davrda yozuv yo‘q',
    'outletFilterAll': 'Butun davr',
    'outletDeliverTitle': 'Mahsulot berish',
    'outletReturnTitle': 'Mahsulot qaytarish',
    'outletPayTitle': 'To‘lov qabul qilish',
    'outletItemsHint': 'Miqdorni kiriting — narx mahsulot narxidan olinadi, kerak bo‘lsa o‘zgartiring',
    'outletPaidNowLabel': 'Hozir naqd to‘landi',
    'outletPaidNowHint': '0 — nasiya',
    'outletTotalLabel': 'Jami',
    'outletAmountLabel': 'Summa',
    'outletEntrySaved': 'Yozildi',
    'outletEntryDeleteBody': 'Bu yozuv o‘chirilsinmi? Qoldiq qayta hisoblanadi.',
    'outletValidationItems': 'Kamida bitta mahsulot miqdorini kiriting',
    'outletValidationAmount': 'Summani kiriting',
    'outletPaidExceeds': 'Naqd summa jamidan oshmasin',
    'cashSettingTrackOutlets': 'Do‘konlar hisob-kitobi',
    'cashSettingTrackOutletsDesc': 'Nasiya berilgan mahsulot — kassadan chiqim, do‘kon to‘lovi — kirim bo‘lib yoziladi',
    'dashboardOutletCredit': 'Do‘kon nasiyasi',
    'outletEdgeHint': 'Bo‘limlar',
  ...
  static const _uzCyrl = {
    ...
    'outletsEmptyTitle': 'Дўконлар ҳали йўқ',
    'outletsEmptySubtitle': 'Маҳсулот тарқатадиган дўконларингизни қўшинг — берилган маҳсулот, тўлов ва қолдиқ шу ерда юритилади.',
    'outletAdd': 'Дўкон қўшиш',
    'outletNew': 'Янги дўкон',
    'outletEdit': 'Дўконни таҳрирлаш',
    'outletNameLabel': 'Дўкон номи',
    'outletNameHint': 'Масалан: Чорсу дўкони',
    'outletAddressHint': 'Кўча, мўлжал',
    'outletUseLocation': 'Жойлашувни олиш',
    'outletLocationSaved': 'Жойлашув олинди',
    'outletPhones': 'Телефон рақамлар',
    'outletPhoneAdd': 'Рақам қўшиш',
    'outletNoteLabel': 'Изоҳ',
    'outletPhotoPick': 'Расм танлаш',
    'outletPhotoRemove': 'Расмни олиб ташлаш',
    'outletSaved': 'Дўкон сақланди',
    'outletDeleteTitle': 'Дўконни ўчириш',
    'outletDeleteBody': '«{name}» ўчирилсинми? Ҳисоб-китоб тарихи сақланиб қолади.',
    'outletDelivered': 'Берилди',
    'outletPaid': 'Тўланди',
    'outletReturned': 'Қайтди',
    'outletBalance': 'Қолдиқ',
    'outletBalanceOwes': 'Дўкон қарзи',
    'outletBalancePrepaid': 'Олдиндан тўланган',
    'outletBalanceSettled': 'Ҳисоб тенг',
    'outletActionDeliver': 'Бериш',
    'outletActionReturn': 'Қайтариш',
    'outletActionPay': 'Тўлов',
    'outletEntryDelivery': 'Маҳсулот берилди',
    'outletEntryReturn': 'Маҳсулот қайтди',
    'outletEntryPayment': 'Тўлов қабул қилинди',
    'outletEntryCashOnDelivery': 'Беришда нақд',
    'outletLedgerEmpty': 'Бу даврда ёзув йўқ',
    'outletFilterAll': 'Бутун давр',
    'outletDeliverTitle': 'Маҳсулот бериш',
    'outletReturnTitle': 'Маҳсулот қайтариш',
    'outletPayTitle': 'Тўлов қабул қилиш',
    'outletItemsHint': 'Миқдорни киритинг — нарх маҳсулот нархидан олинади, керак бўлса ўзгартиринг',
    'outletPaidNowLabel': 'Ҳозир нақд тўланди',
    'outletPaidNowHint': '0 — насия',
    'outletTotalLabel': 'Жами',
    'outletAmountLabel': 'Сумма',
    'outletEntrySaved': 'Ёзилди',
    'outletEntryDeleteBody': 'Бу ёзув ўчирилсинми? Қолдиқ қайта ҳисобланади.',
    'outletValidationItems': 'Камида битта маҳсулот миқдорини киритинг',
    'outletValidationAmount': 'Суммани киритинг',
    'outletPaidExceeds': 'Нақд сумма жамидан ошмасин',
    'cashSettingTrackOutlets': 'Дўконлар ҳисоб-китоби',
    'cashSettingTrackOutletsDesc': 'Насия берилган маҳсулот — кассадан чиқим, дўкон тўлови — кирим бўлиб ёзилади',
    'dashboardOutletCredit': 'Дўкон насияси',
    'outletEdgeHint': 'Бўлимлар',
  ...
  static const _ru = {
    ...
    'outletsEmptyTitle': 'Магазинов пока нет',
    'outletsEmptySubtitle': 'Добавьте магазины, куда отдаёте продукцию — выдачи, оплаты и остаток ведутся здесь.',
    'outletAdd': 'Добавить магазин',
    'outletNew': 'Новый магазин',
    'outletEdit': 'Изменить магазин',
    'outletNameLabel': 'Название магазина',
    'outletNameHint': 'Например: магазин на Чорсу',
    'outletAddressHint': 'Улица, ориентир',
    'outletUseLocation': 'Определить местоположение',
    'outletLocationSaved': 'Местоположение получено',
    'outletPhones': 'Телефоны',
    'outletPhoneAdd': 'Добавить номер',
    'outletNoteLabel': 'Заметка',
    'outletPhotoPick': 'Выбрать фото',
    'outletPhotoRemove': 'Убрать фото',
    'outletSaved': 'Магазин сохранён',
    'outletDeleteTitle': 'Удалить магазин',
    'outletDeleteBody': 'Удалить «{name}»? История расчётов сохранится.',
    'outletDelivered': 'Выдано',
    'outletPaid': 'Оплачено',
    'outletReturned': 'Возврат',
    'outletBalance': 'Остаток',
    'outletBalanceOwes': 'Долг магазина',
    'outletBalancePrepaid': 'Переплата',
    'outletBalanceSettled': 'Расчёт закрыт',
    'outletActionDeliver': 'Выдать',
    'outletActionReturn': 'Возврат',
    'outletActionPay': 'Оплата',
    'outletEntryDelivery': 'Выдача продукции',
    'outletEntryReturn': 'Возврат продукции',
    'outletEntryPayment': 'Оплата получена',
    'outletEntryCashOnDelivery': 'Наличными при выдаче',
    'outletLedgerEmpty': 'За этот период записей нет',
    'outletFilterAll': 'Весь период',
    'outletDeliverTitle': 'Выдать продукцию',
    'outletReturnTitle': 'Возврат продукции',
    'outletPayTitle': 'Принять оплату',
    'outletItemsHint': 'Введите количество — цена берётся из продукта, при необходимости измените',
    'outletPaidNowLabel': 'Оплачено сейчас наличными',
    'outletPaidNowHint': '0 — в долг',
    'outletTotalLabel': 'Итого',
    'outletAmountLabel': 'Сумма',
    'outletEntrySaved': 'Записано',
    'outletEntryDeleteBody': 'Удалить запись? Остаток пересчитается.',
    'outletValidationItems': 'Укажите количество хотя бы одного продукта',
    'outletValidationAmount': 'Введите сумму',
    'outletPaidExceeds': 'Наличные не могут превышать итог',
    'cashSettingTrackOutlets': 'Расчёты с магазинами',
    'cashSettingTrackOutletsDesc': 'Продукция в долг — расход из кассы, оплата магазина — приход',
    'dashboardOutletCredit': 'В долг магазинам',
    'outletEdgeHint': 'Разделы',
  ...
  static const _kk = {
    ...
    'outletsEmptyTitle': 'Дүкендер әзірге жоқ',
    'outletsEmptySubtitle': 'Өнім тарататын дүкендеріңізді қосыңыз — берілген өнім, төлем және қалдық осында жүргізіледі.',
    'outletAdd': 'Дүкен қосу',
    'outletNew': 'Жаңа дүкен',
    'outletEdit': 'Дүкенді өңдеу',
    'outletNameLabel': 'Дүкен атауы',
    'outletNameHint': 'Мысалы: Чорсу дүкені',
    'outletAddressHint': 'Көше, бағдар',
    'outletUseLocation': 'Орналасқан жерді алу',
    'outletLocationSaved': 'Орналасқан жер алынды',
    'outletPhones': 'Телефон нөмірлері',
    'outletPhoneAdd': 'Нөмір қосу',
    'outletNoteLabel': 'Ескертпе',
    'outletPhotoPick': 'Сурет таңдау',
    'outletPhotoRemove': 'Суретті алып тастау',
    'outletSaved': 'Дүкен сақталды',
    'outletDeleteTitle': 'Дүкенді өшіру',
    'outletDeleteBody': '«{name}» өшірілсін бе? Есеп тарихы сақталады.',
    'outletDelivered': 'Берілді',
    'outletPaid': 'Төленді',
    'outletReturned': 'Қайтты',
    'outletBalance': 'Қалдық',
    'outletBalanceOwes': 'Дүкен қарызы',
    'outletBalancePrepaid': 'Алдын ала төленген',
    'outletBalanceSettled': 'Есеп тең',
    'outletActionDeliver': 'Беру',
    'outletActionReturn': 'Қайтару',
    'outletActionPay': 'Төлем',
    'outletEntryDelivery': 'Өнім берілді',
    'outletEntryReturn': 'Өнім қайтты',
    'outletEntryPayment': 'Төлем қабылданды',
    'outletEntryCashOnDelivery': 'Беру кезінде қолма-қол',
    'outletLedgerEmpty': 'Бұл кезеңде жазба жоқ',
    'outletFilterAll': 'Бүкіл кезең',
    'outletDeliverTitle': 'Өнім беру',
    'outletReturnTitle': 'Өнім қайтару',
    'outletPayTitle': 'Төлем қабылдау',
    'outletItemsHint': 'Мөлшерін енгізіңіз — баға өнімнен алынады, қажет болса өзгертіңіз',
    'outletPaidNowLabel': 'Қазір қолма-қол төленді',
    'outletPaidNowHint': '0 — қарызға',
    'outletTotalLabel': 'Барлығы',
    'outletAmountLabel': 'Сома',
    'outletEntrySaved': 'Жазылды',
    'outletEntryDeleteBody': 'Бұл жазба өшірілсін бе? Қалдық қайта есептеледі.',
    'outletValidationItems': 'Кем дегенде бір өнімнің мөлшерін енгізіңіз',
    'outletValidationAmount': 'Соманы енгізіңіз',
    'outletPaidExceeds': 'Қолма-қол сома жалпыдан аспауы керек',
    'cashSettingTrackOutlets': 'Дүкендермен есеп',
    'cashSettingTrackOutletsDesc': 'Қарызға берілген өнім — кассадан шығыс, дүкен төлемі — кіріс',
    'dashboardOutletCredit': 'Дүкен қарызы',
    'outletEdgeHint': 'Бөлімдер',
  ...
  static const _ky = {
    ...
    'outletsEmptyTitle': 'Дүкөндөр азырынча жок',
    'outletsEmptySubtitle': 'Продукт тараткан дүкөндөрүңүздү кошуңуз — берилген продукт, төлөм жана калдык ушул жерде жүргүзүлөт.',
    'outletAdd': 'Дүкөн кошуу',
    'outletNew': 'Жаңы дүкөн',
    'outletEdit': 'Дүкөндү түзөтүү',
    'outletNameLabel': 'Дүкөн аты',
    'outletNameHint': 'Мисалы: Чорсу дүкөнү',
    'outletAddressHint': 'Көчө, багыт',
    'outletUseLocation': 'Жайгашкан жерди алуу',
    'outletLocationSaved': 'Жайгашкан жер алынды',
    'outletPhones': 'Телефон номерлери',
    'outletPhoneAdd': 'Номер кошуу',
    'outletNoteLabel': 'Эскертүү',
    'outletPhotoPick': 'Сүрөт тандоо',
    'outletPhotoRemove': 'Сүрөттү алып салуу',
    'outletSaved': 'Дүкөн сакталды',
    'outletDeleteTitle': 'Дүкөндү өчүрүү',
    'outletDeleteBody': '«{name}» өчүрүлсүнбү? Эсеп тарыхы сакталат.',
    'outletDelivered': 'Берилди',
    'outletPaid': 'Төлөндү',
    'outletReturned': 'Кайтты',
    'outletBalance': 'Калдык',
    'outletBalanceOwes': 'Дүкөн карызы',
    'outletBalancePrepaid': 'Алдын ала төлөнгөн',
    'outletBalanceSettled': 'Эсеп тең',
    'outletActionDeliver': 'Берүү',
    'outletActionReturn': 'Кайтаруу',
    'outletActionPay': 'Төлөм',
    'outletEntryDelivery': 'Продукт берилди',
    'outletEntryReturn': 'Продукт кайтты',
    'outletEntryPayment': 'Төлөм кабыл алынды',
    'outletEntryCashOnDelivery': 'Берүүдө накталай',
    'outletLedgerEmpty': 'Бул мезгилде жазуу жок',
    'outletFilterAll': 'Бүт мезгил',
    'outletDeliverTitle': 'Продукт берүү',
    'outletReturnTitle': 'Продукт кайтаруу',
    'outletPayTitle': 'Төлөм кабыл алуу',
    'outletItemsHint': 'Өлчөмүн киргизиңиз — баа продукттан алынат, керек болсо өзгөртүңүз',
    'outletPaidNowLabel': 'Азыр накталай төлөндү',
    'outletPaidNowHint': '0 — карызга',
    'outletTotalLabel': 'Жалпы',
    'outletAmountLabel': 'Сумма',
    'outletEntrySaved': 'Жазылды',
    'outletEntryDeleteBody': 'Бул жазуу өчүрүлсүнбү? Калдык кайра эсептелет.',
    'outletValidationItems': 'Жок дегенде бир продукттун өлчөмүн киргизиңиз',
    'outletValidationAmount': 'Сумманы киргизиңиз',
    'outletPaidExceeds': 'Накталай сумма жалпыдан ашпасын',
    'cashSettingTrackOutlets': 'Дүкөндөр менен эсеп',
    'cashSettingTrackOutletsDesc': 'Карызга берилген продукт — кассадан чыгым, дүкөн төлөмү — кириш',
    'dashboardOutletCredit': 'Дүкөн карызы',
    'outletEdgeHint': 'Бөлүмдөр',
  ...
  static const _tr = {
    ...
    'outletsEmptyTitle': 'Henüz bayi yok',
    'outletsEmptySubtitle': 'Ürün dağıttığınız bayileri ekleyin — teslimatlar, ödemeler ve bakiye burada tutulur.',
    'outletAdd': 'Bayi ekle',
    'outletNew': 'Yeni bayi',
    'outletEdit': 'Bayiyi düzenle',
    'outletNameLabel': 'Bayi adı',
    'outletNameHint': 'Örneğin: Çarşı bayisi',
    'outletAddressHint': 'Sokak, tarif',
    'outletUseLocation': 'Konumu al',
    'outletLocationSaved': 'Konum alındı',
    'outletPhones': 'Telefonlar',
    'outletPhoneAdd': 'Numara ekle',
    'outletNoteLabel': 'Not',
    'outletPhotoPick': 'Fotoğraf seç',
    'outletPhotoRemove': 'Fotoğrafı kaldır',
    'outletSaved': 'Bayi kaydedildi',
    'outletDeleteTitle': 'Bayiyi sil',
    'outletDeleteBody': '«{name}» silinsin mi? Hesap geçmişi korunur.',
    'outletDelivered': 'Teslim',
    'outletPaid': 'Ödendi',
    'outletReturned': 'İade',
    'outletBalance': 'Bakiye',
    'outletBalanceOwes': 'Bayi borcu',
    'outletBalancePrepaid': 'Ön ödeme',
    'outletBalanceSettled': 'Hesap kapalı',
    'outletActionDeliver': 'Teslim',
    'outletActionReturn': 'İade',
    'outletActionPay': 'Ödeme',
    'outletEntryDelivery': 'Ürün teslimi',
    'outletEntryReturn': 'Ürün iadesi',
    'outletEntryPayment': 'Ödeme alındı',
    'outletEntryCashOnDelivery': 'Teslimatta nakit',
    'outletLedgerEmpty': 'Bu dönemde kayıt yok',
    'outletFilterAll': 'Tüm dönem',
    'outletDeliverTitle': 'Ürün teslim et',
    'outletReturnTitle': 'Ürün iadesi',
    'outletPayTitle': 'Ödeme al',
    'outletItemsHint': 'Miktarı girin — fiyat üründen alınır, gerekirse değiştirin',
    'outletPaidNowLabel': 'Şimdi nakit ödendi',
    'outletPaidNowHint': '0 — veresiye',
    'outletTotalLabel': 'Toplam',
    'outletAmountLabel': 'Tutar',
    'outletEntrySaved': 'Kaydedildi',
    'outletEntryDeleteBody': 'Bu kayıt silinsin mi? Bakiye yeniden hesaplanır.',
    'outletValidationItems': 'En az bir ürün miktarı girin',
    'outletValidationAmount': 'Tutarı girin',
    'outletPaidExceeds': 'Nakit tutar toplamı aşamaz',
    'cashSettingTrackOutlets': 'Bayi hesapları',
    'cashSettingTrackOutletsDesc': 'Veresiye ürün — kasadan gider, bayi ödemesi — gelir olarak yazılır',
    'dashboardOutletCredit': 'Bayi veresiyesi',
    'outletEdgeHint': 'Bölümler',
